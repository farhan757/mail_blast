...
@section('tittlebar','List Users Field Email System')
...
<div class="module">
							<div class="module-head">
								<h3>Settings > List Users</h3>
							</div>
                            <div class="module-body">
                                <b><a href="{{ route('settings.user.form') }}" class="icon-plus btn"><span class="success"> Add</span></a></b>
                            </div>
